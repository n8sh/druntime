...
{
    // https://github.com/openbsd/src/blob/master/sys/netinet/in.h
...
{
    // https://github.com/openbsd/src/blob/master/sys/netinet6/in6.h
    struct in6_addr
    {
        union
        {
    ...
    extern (D) @nogc nothrow pure
    {
        ...
        uint8_t __IPV6_ADDR_MC_SCOPE()(in in6_addr* a)
        {
            return a.s6_addr[1] & 0x0f;
        }
...
else version (Haiku)
{
    ...
    struct in6_addr
    {
        ...
        {
            uint8_t[16] s6_addr;
            uint16_t[8] s6_addr16; // Not used in Haiku.
            uint32_t[4] s6_addr32; // Not used in Haiku.
        }
    }
    ...
    extern (D) @nogc nothrow pure
    {
        import core.stdc.stdlib : memcmp;
        bool IN6_IS_ADDR_UNSPECIFIED()(in in6_addr* a)
        {
            return a.s6_addr == in6addr_any.s6_addr;
        }

        bool IN6_IS_ADDR_LOOPBACK()(in in6_addr* a)
        {
            return a.s6_addr == in6addr_loopback.s6_addr;
        }

        bool IN6_IS_ADDR_V4COMPAT()(in in6_addr* a)
        {
            return (a.s6_addr8[0] == 0x00 && a.s6_addr8[1] == 0x00
                   && a.s6_addr8[2] == 0x00 && a.s6_addr8[3] == 0x00
                   && a.s6_addr8[4] == 0x00 && a.s6_addr8[5] == 0x00
                   && a.s6_addr8[6] == 0x00 && a.s6_addr8[7] == 0x00
                   && a.s6_addr8[8] == 0x00 && a.s6_addr8[9] == 0x00
                   && a.s6_addr8[10] == 0x00 && a.s6_addr8[11] == 0x01);
        }
        ...
        bool IN6_IS_ADDR_V4MAPPED()(in in6_addr* a)
        {
            return (a.s6_addr8[0] == 0x00 && a.s6_addr8[1] == 0x00
                   ...
                   && a.s6_addr8[6] == 0x00 && a.s6_addr8[7] == 0x00
                   && a.s6_addr8[8] == 0x00 && a.s6_addr8[9] == 0x00
                   && a.s6_addr8[10] == 0xff && a.s6_addr8[11] == 0xff);
        }
